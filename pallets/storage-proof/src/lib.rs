...
use frame_support::{
	dispatch::DispatchResult, ensure, pallet_prelude::*,
	traits::EnsureOrigin,
};
...
#[derive(Clone, Encode, Decode, PartialEq, Eq, Debug, TypeInfo, MaxEncodedLen, codec::DecodeWithMemTracking, Default)]
pub enum ProofType {
...
#[derive(Clone, Encode, Decode, PartialEq, Eq, Debug, TypeInfo, MaxEncodedLen, codec::DecodeWithMemTracking)]
	...
	pub trait Config: frame_system::Config
{
	...
	#[pallet::storage]
	pub type StorageProofs<T: Config> = StorageMap<
		_,
		Blake2_128Concat,
		ContentId,
		ProofRecord<BlockNumberFor<T>, T::AccountId>,
	>;
	...
	pub enum Event<T: Config> {
		...
		StorageProofAccepted { content_id: ContentId, submitter: T::AccountId },
